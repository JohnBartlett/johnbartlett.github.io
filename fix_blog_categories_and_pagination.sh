...
# Update index.md for pagination
cat > index.md << EOL
---
layout: home
author_profile: true
...
<h2>Posts in "{{ page.title }}" category</h2>
...
git add .
git commit -m "Fix blog categories, pagination, and site structure"
